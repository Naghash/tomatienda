...
import com.tomatienda.myapp.repository.ClienteRepository;
import com.tomatienda.myapp.service.ClienteService;
...
public class ClienteResourceIntTest {
    ...
    private static final String DEFAULT_EMAIL = "w@F\\oGUW";
    private static final String UPDATED_EMAIL = "z@o\\\\aRWcg";

    private static final Integer DEFAULT_COMPRAS = 1;
    private static final Integer UPDATED_COMPRAS = 2;
    ...
    public void createCliente() throws Exception {
        ...
        assertThat(testCliente.getCompras()).isEqualTo(DEFAULT_COMPRAS);
        assertThat(testCliente.getTotal()).isEqualTo(DEFAULT_TOTAL);
    }
    ...
    public void getAllClientes() throws Exception {
        ...
        restClienteMockMvc.perform(get("/api/clientes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].compras").value(hasItem(DEFAULT_COMPRAS)))
    ...
    public void getCliente() throws Exception {
        ...
        restClienteMockMvc.perform(get("/api/clientes/{id}", cliente.getId()))
            ...
            .andExpect(jsonPath("$.compras").value(DEFAULT_COMPRAS))
    ...
    public void updateCliente() throws Exception {
        ...
        assertThat(testCliente.getCompras()).isEqualTo(UPDATED_COMPRAS);
        assertThat(testCliente.getTotal()).isEqualTo(UPDATED_TOTAL);
    }
